...
#pragma ident	"@(#)dlpi.h	1.4	89/11/09 SMI"	/* SVr4.0 1.2	*/
 ...
 */
typedef struct {
		long	dl_target_value;	/* bits/second desired */
		long	dl_accept_value;	/* min. ok bits/second */
} dl_through_t;
...
typedef struct {
		...
		long	dl_accept_value;	/* min. ok value of service */
} dl_transdelay_t;
 ...
 */
typedef struct {
		long	dl_disc_prob;	/* prob. of provider init DISC */
		long	dl_reset_prob;	/* prob. of provider init RESET */
} dl_resilience_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;			/* set to DL_INFO_REQ */
} dl_info_req_t;
 ...
 */
typedef struct {
	u_long		dl_primitive;  		/* set to DL_INFO_ACK */
	u_long		dl_max_sdu;		/* Max bytes in a DLSDU */
	u_long		dl_min_sdu;		/* Min bytes in a DLSDU */
	u_long		dl_addr_length;		/* length of DLSAP address */
	u_long		dl_mac_type;		/* type of medium supported */
	u_long		dl_reserved;		/* value set to zero */
	u_long		dl_current_state;	/* state of DLPI interface */
	long		dl_sap_length;		/* length of dlsap SAP part */
	u_long		dl_service_mode;	/* CO, CL or ACL */
	u_long		dl_qos_length;		/* length of qos values */
	u_long		dl_qos_offset;		/* offset from beg. of block */
	u_long		dl_qos_range_length;	/* available range of qos */
	u_long		dl_qos_range_offset;	/* offset from beg. of block */
	u_long		dl_provider_style;	/* style1 or style2 */
	u_long 		dl_addr_offset;		/* offset of the dlsap addr */
	u_long		dl_version;		/* version number */
	u_long		dl_brdcst_addr_length;	/* length of broadcast addr */
	u_long		dl_brdcst_addr_offset;	/* offset from beg. of block */
	u_long		dl_growth;		/* set to zero */
} dl_info_ack_t;
 ...
 */
typedef struct {
	u_long		dl_primitive;		/* set to DL_ATTACH_REQ */
	u_long		dl_ppa;			/* id of the PPA */
} dl_attach_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;			/* set to DL_DETACH_REQ */
} dl_detach_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* set to DL_BIND_REQ */
	u_long	dl_sap;			/* info to identify dlsap addr */
	u_long	dl_max_conind;		/* max # of outstanding con_ind */
	ushort	dl_service_mode;	/* CO, CL or ACL */
	ushort	dl_conn_mgmt;		/* if non-zero, is con-mgmt stream */
	u_long	dl_xidtest_flg;		/* auto init. of test and xid */
} dl_bind_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_BIND_ACK */
	u_long	dl_sap;			/* DLSAP addr info */
	u_long	dl_addr_length;		/* length of complete DLSAP addr */
	u_long	dl_addr_offset;		/* offset from beginning of M_PCPROTO */
	u_long	dl_max_conind;		/* allowed max. # of con-ind */
	u_long	dl_xidtest_flg;		/* responses supported by provider */
} dl_bind_ack_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_SUBS_BIND_REQ */
	u_long 	dl_subs_sap_offset;	/* offset of subs_sap */
	u_long	dl_subs_sap_length;	/* length of subs_sap */
	u_long	dl_subs_bind_class;	/* peer or hierarchical */
} dl_subs_bind_req_t;
 ...
 */
typedef struct {
	u_long dl_primitive;		/* DL_SUBS_BIND_ACK */
	u_long dl_subs_sap_offset;	/* offset of subs_sap */
	u_long dl_subs_sap_length;	/* length of subs_sap */
} dl_subs_bind_ack_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_UNBIND_REQ */
} dl_unbind_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_SUBS_UNBIND_REQ */
	u_long 	dl_subs_sap_offset;	/* offset of subs_sap */
	u_long	dl_subs_sap_length;	/* length of subs_sap */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_OK_ACK */
	u_long	dl_correct_primitive;	/* primitive being acknowledged */
} dl_ok_ack_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_ERROR_ACK */
	u_long	dl_error_primitive;	/* primitive in error */
	u_long	dl_errno;		/* DLPI error code */
	u_long	dl_unix_errno;		/* UNIX system error code */
} dl_error_ack_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_ENABMULTI_REQ */
	u_long	dl_addr_length;		/* length of multicast address */
	u_long	dl_addr_offset;		/* offset from beg. of M_PROTO block */
} dl_enabmulti_req_t;
...
typedef struct {
	u_long	dl_primitive;		/* DL_DISABMULTI_REQ */
	u_long	dl_addr_length;		/* length of multicast address */
	u_long	dl_addr_offset;		/* offset from beg. of M_PROTO block */
} dl_disabmulti_req_t;
...
typedef struct {
	u_long	dl_primitive;		/* DL_PROMISCON_REQ */
	u_long	dl_level;		/* physical,SAP, or ALL multicast */
} dl_promiscon_req_t;
...
typedef struct {
	u_long 	dl_primitive;		/* DL_PROMISCOFF_REQ */
	u_long	dl_level;		/* Physical,SAP, or ALL multicast */
} dl_promiscoff_req_t;
 ...
 */
typedef	struct {
	u_long	dl_primitive;		/* DL_PHYS_ADDR_REQ */
	u_long	dl_addr_type;		/* factory or current physical addr */
} dl_phys_addr_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_PHYS_ADDR_ACK */
	u_long	dl_addr_length;		/* length of the physical addr */
	u_long	dl_addr_offset;		/* offset from beg. of block */
} dl_phys_addr_ack_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_SET_PHYS_ADDR_REQ */
	u_long	dl_addr_length;		/* length of physical addr */
	u_long	dl_addr_offset;		/* offset from beg. of block */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_GET_STATISTICS_REQ */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_GET_STATISTICS_ACK */
	u_long	dl_stat_length;		/* length of statistics structure */
	u_long	dl_stat_offset;		/* offset from beg. of block */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_CONNECT_REQ */
	u_long	dl_dest_addr_length;	/* len. of dlsap addr */
	u_long	dl_dest_addr_offset;	/* offset */
	u_long	dl_qos_length;		/* len. of QOS parm val */
	u_long	dl_qos_offset;		/* offset */
	u_long	dl_growth;		/* set to zero */
} dl_connect_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_CONNECT_IND */
	u_long	dl_correlation;		/* provider's correlation token */
	u_long	dl_called_addr_length;  /* length of called address */
	u_long	dl_called_addr_offset;	/* offset from beginning of block */
	u_long	dl_calling_addr_length;	/* length of calling address */
	u_long	dl_calling_addr_offset;	/* offset from beginning of block */
	u_long	dl_qos_length;		/* length of qos structure */
	u_long	dl_qos_offset;		/* offset from beginning of block */
	u_long	dl_growth;		/* set to zero */
} dl_connect_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;	/* DL_CONNECT_RES */
	u_long	dl_correlation; /* provider's correlation token */
	u_long	dl_resp_token;	/* token associated with responding stream */
	u_long	dl_qos_length;  /* length of qos structure */
	u_long	dl_qos_offset;	/* offset from beginning of block */
	u_long	dl_growth;	/* set to zero */
} dl_connect_res_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_CONNECT_CON */
	u_long	dl_resp_addr_length;	/* length of responder's address */
	u_long	dl_resp_addr_offset;	/* offset from beginning of block */
	u_long	dl_qos_length;		/* length of qos structure */
	u_long	dl_qos_offset;		/* offset from beginning of block */
	u_long	dl_growth;		/* set to zero */
} dl_connect_con_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_TOKEN_REQ */
} dl_token_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;	/* DL_TOKEN_ACK */
	u_long	dl_token;	/* Connection response token */
}dl_token_ack_t;
 ...
 */
typedef struct {
	u_long		dl_primitive;	/* DL_DISCONNECT_REQ */
	u_long		dl_reason;	/* norm., abnorm., perm. or trans. */
	u_long		dl_correlation; /* association with connect_ind */
} dl_disconnect_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_DISCONNECT_IND */
	u_long	dl_originator;		/* USER or PROVIDER */
	u_long	dl_reason;		/* permanent or transient */
	u_long	dl_correlation;		/* association with connect_ind */
} dl_disconnect_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_RESET_REQ */
} dl_reset_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_RESET_IND */
	u_long	dl_originator;		/* Provider or User */
	u_long	dl_reason;		/* flow control, link error, resync */
} dl_reset_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_RESET_RES */
} dl_reset_res_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_RESET_CON */
} dl_reset_con_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_UNITDATA_REQ */
	u_long	dl_dest_addr_length;	/* DLSAP length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_UNITDATA_IND */
	u_long	dl_dest_addr_length;	/* DLSAP length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
	u_long	dl_src_addr_length;	/* DLSAP addr length of sending user */
	u_long	dl_src_addr_offset;	/* offset from beg. of block */
	u_long	dl_group_address;	/* set to one if multicast/broadcast */
} dl_unitdata_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_UDERROR_IND */
	u_long	dl_dest_addr_length;	/* Destination DLSAP */
	u_long	dl_dest_addr_offset;	/* Offset from beg. of block */
	u_long	dl_unix_errno;		/* unix system error code */
	u_long	dl_errno;		/* DLPI error code */
} dl_uderror_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_UDQOS_REQ */
	u_long	dl_qos_length;		/* length in bytes of requested qos */
	u_long	dl_qos_offset;		/* offset from beg. of block */
} dl_udqos_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_TEST_REQ */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* DLSAP length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
} dl_test_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_TEST_IND */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* dlsap length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
	u_long	dl_src_addr_length;	/* dlsap length of source user */
	u_long	dl_src_addr_offset;	/* offset from beg. of block */
} dl_test_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_TEST_RES */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* DLSAP length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
} dl_test_res_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_TEST_CON */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* dlsap length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
	u_long	dl_src_addr_length;	/* dlsap length of source user */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_XID_REQ */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* dlsap length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
} dl_xid_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_XID_IND */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* dlsap length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
	u_long	dl_src_addr_length;	/* dlsap length of source user */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_XID_RES */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* DLSAP length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
} dl_xid_res_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_XID_CON */
	u_long	dl_flag;		/* poll/final */
	u_long	dl_dest_addr_length;	/* dlsap length of dest. user */
	u_long	dl_dest_addr_offset;	/* offset from beg. of block */
	u_long	dl_src_addr_length;	/* dlsap length of source user */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_DATA_ACK_REQ */
	u_long	dl_correlation;		/* User's correlation token */
	u_long	dl_dest_addr_length;	/* length of destination addr */
	u_long	dl_dest_addr_offset;	/* offset from beginning of block */
	u_long	dl_src_addr_length;	/* length of source address */
	u_long	dl_src_addr_offset;	/* offset from beginning of block */
	u_long	dl_priority;		/* priority */
	u_long	dl_service_class;	/* DL_RQST_RSP or DL_RQST_NORSP */
} dl_data_ack_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_DATA_ACK_IND */
	u_long	dl_dest_addr_length;	/* length of destination addr */
	u_long	dl_dest_addr_offset;	/* offset from beginning of block */
	u_long	dl_src_addr_length;	/* length of source address */
	u_long	dl_src_addr_offset;	/* offset from beginning of block */
	u_long 	dl_priority;		/* priority for data unit transm. */
	u_long	dl_service_class;	/* DL_RQST_RSP or DL_RQST_NORSP */
} dl_data_ack_ind_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_DATA_ACK_STATUS_IND */
	u_long	dl_correlation;		/* User's correlation token */
	u_long	dl_status;		/* success or failure of previous req */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_REPLY_REQ */
	u_long	dl_correlation;		/* User's correlation token */
	u_long	dl_dest_addr_length;	/* length of destination address */
	u_long	dl_dest_addr_offset;	/* offset from beginning of block */
	u_long	dl_src_addr_length;	/* source address length */
	u_long	dl_src_addr_offset;	/* offset from beginning of block */
	u_long	dl_priority;		/* pri for data unit transmission */
	u_long	dl_service_class;
} dl_reply_req_t;
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_REPLY_IND */
	u_long	dl_dest_addr_length;	/* length of destination address */
	u_long	dl_dest_addr_offset;	/* offset from beginning of block */
	u_long	dl_src_addr_length;	/* length of source address */
	u_long	dl_src_addr_offset;	/* offset from beginning of block */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_REPLY_STATUS_IND */
	u_long	dl_correlation;		/* User's correlation token */
	u_long	dl_status;		/* success or failure of previous req */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_REPLY_UPDATE_REQ */
	u_long	dl_correlation;		/* user's correlation token */
	u_long	dl_src_addr_length;	/* length of source address */
	u_long	dl_src_addr_offset;	/* offset from beginning of block */
 ...
 */
typedef struct {
	u_long	dl_primitive;		/* DL_REPLY_UPDATE_STATUS_IND */
	u_long	dl_correlation;		/* User's correlation token */
	u_long	dl_status;		/* success or failure of previous req */
